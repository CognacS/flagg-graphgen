...
def get_subgraph_splits(
    ...
    graph_a = graph.selective_deepcopy(graph.get_all_other_attrs() + graph.get_all_special_attrs())
    graph_b = graph.selective_deepcopy(graph.get_all_other_attrs() + graph.get_all_special_attrs())
...
def merge_subgraphs(
    ...
    graph = graph_a.selective_deepcopy(graph_a.get_all_other_attrs() + graph_a.get_all_special_attrs())
