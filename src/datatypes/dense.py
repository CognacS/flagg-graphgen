...
class DenseGraph:
    ...
    def apply_mask(self) -> DenseGraph:
        ...
        if self.x is not None:
            ...
            if self.edge_mask is None and self.edge_adjmat is not None:
                raise DenseGraphException(
    ...
    def transpose(self):
        new_graph = copy(self)
        new_graph.edge_adjmat = new_graph.edge_adjmat.transpose(1, 2)
        if new_graph.edge_mask is not None:
            new_graph.edge_mask = new_graph.edge_mask.transpose(1, 2)
