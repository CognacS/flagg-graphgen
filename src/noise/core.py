...
class NoiseProcess (nn.Module):
	...
	def sample_noise_posterior_s_t(self, original_datapoint, current_datapoint, t, s, **kwargs):
		raise NotImplementedError
	...
	def apply_noise_posterior_s_t(self, original_datapoint, current_datapoint, noise, t, s, **kwargs):
		raise NotImplementedError
	...
	def sample_posterior_s_t(self, original_datapoint, current_datapoint, t, s, noise=None, **kwargs):
		
		if noise is None:
			noise = self.sample_noise_posterior_s_t(original_datapoint, current_datapoint, t, s, **kwargs)

		prev_datapoint = self.apply_noise_posterior_s_t(original_datapoint, current_datapoint, noise, t, s, **kwargs)
