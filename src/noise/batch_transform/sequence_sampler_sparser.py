...
def sample_sequences_sparser(
    ...
    curr_batch.node_select = torch.zeros(curr_batch.num_nodes, dtype=torch.float, device=batch.x.device)
    ...
    for t in range(1, max_max_time+1):
        ...
        surv_batch.node_select[remv_edges_ba.edge_index[1]] = 1.
